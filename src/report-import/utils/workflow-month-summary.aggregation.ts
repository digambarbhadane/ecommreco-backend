...
export function buildAmazonWorkflowMonthSummaryPipeline(
  ...
  const isAmazonReturnRow = {
    $or: [isAmazonRefund, isAmazonReturnOnly],
  };
  const isAmazonSalesExclusion = {
    $or: [isAmazonReturnRow, isAmazonCancellation],
  };
  ...
  const isAmazonShipment = {
    $and: [
      ...
      { $not: isAmazonSalesExclusion },
    ],
  };
  const isAmazonGrossSale = { $not: isAmazonSalesExclusion };
        ...
        totals: [
          {
            $group: {
              ...
              amazonReturnTotalRows: sumWhen(isAmazonReturnRow, 1),
              ...
              amazonReturnTotalPcs: sumWhen(isAmazonReturnRow, absQty),
